  ...
  <div class="xor-gate-page-box">
    ...
    <div :class="{ 'handle-box': true, handled: handled }">
      ...
      >
        ...
        <circle r="6" fill="var(--border-color)" style="offset-path: path('m190 115h185v90h185')" />
      </LogicWire>
      <LogicWire
        class="wire-front b"
        :width="562"
      ...
      <XorGate class="gate" :size="'10cqw'" :a="wire_a" :b="wire_b" v-model="wire_y" />
    </div>

    <transition name="slide-to-left">
      <MainHandleButton class="next" v-if="handled" @click="next_page">
        {{ $t('xor_gate_page.next_section') }}
      </MainHandleButton>
    </transition>
  </div>
</template>
