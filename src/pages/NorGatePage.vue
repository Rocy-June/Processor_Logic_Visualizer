  ...
  <div class="nor-gate-page-box">
    ...
    <div :class="{ 'handle-box': true, handled: handled }">
      ...
      <LogicWire
        ...
        v-model="wire_a"
      >
        <path d="m190 115h165v90h185" />
        <circle r="6" fill="var(--border-color)" style="offset-path: path('m190 115h165v90h185')" />
      </LogicWire>
      <LogicWire
        class="wire-front b"
        :width="562"
        ...
        v-model="wire_b"
      >
        <path d="m190 115h165v-90h185" />
        <circle
          r="6"
          fill="var(--border-color)"
          style="offset-path: path('m190 115h165v-90h185')"
        />
      </LogicWire>
      <LogicWire
        class="wire-back"
